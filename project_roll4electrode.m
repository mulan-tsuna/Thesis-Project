  ...
  % function create model and find different voltage from roll 4 electrode 
...
% roll 4 elelctrode
electrode_geometry{1,:}.cylinder.top_center     = [15.7, 12.501 , 3.05];
electrode_geometry{1,:}.cylinder.bottom_center  = [15.7, 12.501 , 3];
   
electrode_geometry{2,:}.cylinder.top_center     = [17.35, 12.501, 3.05];
electrode_geometry{2,:}.cylinder.bottom_center  = [17.35, 12.501, 3];
    
electrode_geometry{3,:}.cylinder.top_center     = [19, 12.501, 3.05];
electrode_geometry{3,:}.cylinder.bottom_center  = [19, 12.501, 3]; 

electrode_geometry{4,:}.cylinder.top_center     = [20.65,  12.501, 3.05];
electrode_geometry{4,:}.cylinder.bottom_center  = [20.65,  12.501, 3];
...
body_geometry{2}.cylinder.top_center    = [18.2 12.501 3];
body_geometry{2}.cylinder.bottom_center = [18.2 12.501 thickness_CIN2];
...
save(['D:\1Reported\4_electrode\' 'diffVOltage_4roll_' cin_case '_' freq_case '.mat']);
